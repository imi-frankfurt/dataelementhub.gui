  ...
  <div>
    <div v-if="dataElement !== undefined">
      ...
      <v-list v-if="dataElement.relations.length > 0">
        ...
        <v-list-item>
          <v-list-item-content>
            <relation-table-detail-view-child
...
import RelationTableDetailViewChild from '~/components/tables/relation-table-detail-view-child'
      ...
      await this.$axios.$get(this.ajax.dataElementUrl + this.urn, Ajax.header.ignoreLanguage)
        .then(function (res) {
          ...
          this.$axios.$get(this.ajax.dataElementUrl + this.urn + '/relations', Ajax.header.ignoreLanguage)
            .then(function (res1) {
              dataElement.relations = res1
              this.dataElement = Object.assign({}, dataElement)
            }.bind(this))
            .catch(function (err) {
              this.$log.error('Could not fetch 1relations: ' + err)
            }.bind(this))
        }.bind(this))
        .catch(function (err) {
